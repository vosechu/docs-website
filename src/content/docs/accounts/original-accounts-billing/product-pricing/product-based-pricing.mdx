...
metaDescription: >-
  An explanation of New Relic's original pricing plan, which was based on
  subscriptions to specific products.
redirects:
  - /docs/subscriptions/subscription-pricing
  - >-
    /docs.newrelic.com/docs/accounts-partnerships/accounts/account-setup/subscription-pricing
...
## Annual vs monthly pricing plans [#pricing-plans]
...
<CollapserGroup>
  ...
  >
    ...
    * [Child accounts](/docs/accounts-partnerships/accounts/account-setup/create-sub-accounts) if applicable
