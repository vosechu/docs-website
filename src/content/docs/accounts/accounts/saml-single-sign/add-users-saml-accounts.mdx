...
metaDescription: How to add users to New Relic account via SAML single sign-on (SSO).
redirects:
...
<Callout variant="important">
  These docs are for setting up SSO for users on our [original user model](/docs/accounts/original-accounts-billing/original-product-based-pricing/overview-changes-pricing-user-model#how-pricing-users-relate). For an overview of SAML and SCIM options, see [Introduction to SAML SSO and SCIM](/docs/accounts/accounts-billing/new-relic-one-user-management/introduction-saml-scim). 
</Callout>
