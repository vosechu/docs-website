...
This document provides examples and reference information for our API endpoints. For developer-focused content on how to use and customize New Relic, see **[developer.newrelic.com](https://developer.newrelic.com/)**.

<Callout variant="tip">
  To use APIs and SDKs, as well as the rest of our [observability platform](https://one.newrelic.com), join the New Relic family! [Sign up](https://newrelic.com/signup) to create your free account in only a few seconds. Then ingest up to 100GB of data for free each month. Forever.
</Callout>


## Ingest APIs for core data types [#data-type-apis]

We have [many solutions for reporting data](/docs/telemetry-data-platform/get-started/introduction-new-relic-data-ingest-apis-sdks), and our APIs are one of these ways. These APIs can be used directly, but they're also the underlying ingest route for many of our more curated tools, such as our [open source telemetry integrations](/docs/integrations/open-source-telemetry-integrations/get-started/introduction-new-relics-open-source-telemetry-integrations) and our [Telemetry SDKs](/docs/telemetry-data-platform/ingest-apis/telemetry-sdks-report-custom-telemetry-data). 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Event API](/docs/insights/insights-data-sources/custom-data/insert-custom-events-insights-api)
      </td>
...
NerdGraph is the preferred API for querying New Relic data and making a range of feature configurations. [NerdGraph](/docs/apis/graphql-api/getting-started/introduction-new-relic-graphql-api) is our GraphQL-format API: GraphQL is an efficient and flexible query language that lets you request exactly the data you need, without over-fetching or under-fetching. 
...
New Relic capabilities, like APM, infrastructure monitoring, or alerts, are often used together, and sometimes they overlap in functionality. This is why multiple APIs may be relevant to each area. Some API functionality will depend on your [access to features and data](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To query APM data, use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api).
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To retrieve browser monitoring data, use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api).
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            To retrieve infrastructure data, use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api). This API can also be used to retrieve [subscription usage data](/docs/accounts/new-relic-account-usage/getting-started/introduction-subscription-usage-data#api).
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To retrieve mobile monitoring data from New Relic, use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api).
          </td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To retrieve [synthetics event data](/docs/insights/insights-data-sources/default-events-attributes/synthetics-default-events-attributes-insights), use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api).
          </td>
        </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * Return a [list of account users](/docs/apis/rest-api-v2/account-examples-v2/listing-users-your-account) ([original user model](https://docs.newrelic.com/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model) only).
...
Insights-related APIs include:
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            To query your data using NRQL-format queries, you can use the [Query API](/docs/insights/insights-api/get-data/query-insights-event-data-api). Note that this API is deprecated and [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph) is preferred for querying your data. 
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            See the [Insights Dashboard API](/docs/insights/insights-api/manage-dashboards/insights-dashboard-api).
          </td>
        </tr>
  ...
  <Collapser
    ...
    title="Plugins"
  >
Use the [REST API for New Relic plugins](/docs/apis/rest-api-v2/plugin-examples-v2) and the API Explorer to:
...
Developers and New Relic partners can also use New Relic's [Plugin API](/docs/plugins/plugin-developer-resources/developer-reference/work-directly-plugin-api) to write an agent in any language that can work directly with the API for plugins. This allows you to send your own metric data to our plugins and view data received from the API in New Relic.
  </Collapser>
</CollapserGroup>

## See APIs in action [#developer-site]

For more on how you as a developer can optimize your ability to solve problems using New Relic, go to **[developer.newrelic.com](https://developer.newrelic.com/)**.
