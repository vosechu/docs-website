...
<table>
  ...
  <tbody>
      ...
      <td>
        Send event data to New Relic without use of an agent or integration. Also note that our agents have their own methods for sending events. For an overview, see [Send custom events](/docs/telemetry-data-platform/custom-data/custom-events/report-custom-event-data/#ways).
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Send distributed tracing data to New Relic without use of an agent or integration.
      </td>
    </tr>
    <tr>
      <td>
...
[NerdGraph](/docs/apis/graphql-api/getting-started/introduction-new-relic-graphql-api) is the recommended API for querying New Relic data and for making feature configurations. NerdGraph is a GraphQL-format API: GraphQL is an efficient and flexible query language that lets you request exactly the data you need, without over-fetching or under-fetching. 
