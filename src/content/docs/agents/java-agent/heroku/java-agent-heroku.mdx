...
<CollapserGroup>
  ...
  <Collapser title="Manual configuration">
    ...
    8. Also in `newrelic.yml`, add your [license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key) to the [`license_key`](/docs/agents/java-agent/configuration/java-agent-configuration-config-file#cfg-license_key) setting.
  </Collapser>
</CollapserGroup>
